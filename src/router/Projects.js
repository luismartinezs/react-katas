    ...
    return (
      <main className="d-flex justify-center align-center">
        <div className="projects__container">
          ...
          <Project name="Project 1" imgAlign="left" />
          <Project name="Project 2" imgAlign="right" />
          <Project name="Project 3" imgAlign="left" />
          <Project name="Project 4" imgAlign="right" />
        </div>
      </main>
    );
  }
  ...
  render() {
    ...
    return (
      <article className="d-flex justify-center">
        <img
          src={`https://picsum.photos/${imgSize.w}/${imgSize.h}/?random`}
          alt={this.props.name}
        ...
        <div className="project__description">
          ...
          <h3><em>Neque porro quisquam est</em></h3>
          <p>
